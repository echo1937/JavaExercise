...
public class CharsetConverter {
    public static void main(String args[]) throws IOException {
        ...
        */
        ...
        Charset cs;
        cb=Charset.forName("UTF-8").decode(ByteBuffer.wrap("你好".getBytes("UTF-8")));
        System.out.println(cb);  //打印“你好”
...
//        bb=Charset.forName("GBK").encode("你好");
//        cb=Charset.forName("GBK").decode(bb);


        cb=Charset.forName("GBK").decode(Charset.forName("GBK").encode("你好"));
